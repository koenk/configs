...
networkwidget:set_color("#FF5656")
networkwidget:set_gradient_colors({ "#FF5656", "#88A175", "#AECF96" })
networkwidget:set_gradient_angle(0)
networktooltip = awful.tooltip({ objects = {networkwidget.widget}, })
vicious.register(networkwidget,
                 vicious.widgets.net,
                 function (widget, args)
                     networktooltip:set_text("Network: "..args["{wlan0 down_kb}"].."KB/s "..args["{wlan0 up_kb}"].."KB/s")
                     return 100 * (args["{wlan0 down_mb}"] + args["{wlan0 up_mb}"])
                 end)
